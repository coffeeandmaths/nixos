...
Boot from the NixOS minimal ISO.  
The following commands will set up Wi-Fi, partition, install NixOS, copy your SSH key from USB, clone your dotfiles, and deploy the flake.
...
lsblk
cfdisk /dev/sda
# In cfdisk: create /boot (1G, type 83 Linux), / (rest of disk, type 83 Linux)
mkfs.ext4 /dev/sda1
mkfs.ext4 /dev/sda2
